...
This year, the [UNICEF Venture Fund](https://www.unicefinnovationfund.org/) celebrates [five graduating companies](https://www.unicef.org/innovation/venturefund/blockchain-financial-inclusion-graduation) from a recent investment round. For the first time, many of these companies are exiting from the Venture Fund having already earned recognition as [Digital Public Goods (DPGs)](https://digitalpublicgoods.net/registry/). With the support of a cross-sectional team of mentors, these graduating companies worked to achieve compliance with the [DPG Standard](https://digitalpublicgoods.net/standard/).

The [Digital Public Good Standard](https://digitalpublicgoods.net/standard/) offers a nine-point baseline for evaluation and recognition of Open Source software, content, data, and standards that adhere to privacy and other applicable laws and best practices, do no harm by design, and help attain the Sustainable Development Goals (SDGs). Once a solution is recognised as a digital public good it is discoverable on the [DPG Registry](https://digitalpublicgoods.net/registry/).
...
Further complementing the core Technical Assistance programme, [specialized workshops](https://www.unicefinnovationfund.org/broadcast/expert-posts/unicef-innovation-fund-blockchain-cohort-onboarding-workshops) were held by like-minded institutions outside the Venture Fund’s core team of mentors , along with personalized mentorship sessions. The recent Blockchain Cohort, for example, benefitted from targeted mentorship from AW3L, a blockchain consulting firm that share many of UNICEF's values around leveraging blockchain for social impact.
...
What comes next? The Technical Assistance programmes at the UNICEF Venture Fund are gearing up for additional cohorts benefiting from our seed-stage investment: a [Data Science & A.I. cohort](https://www.unicef.org/innovation/innovationfund/ai-ds-learning-health-2022) and an upcoming Blockchain cohort. These early-stage companies undergo a technical assistance programme involving a technical and strategic workshop series and monthly mentorship meetings. Graduates of our seed-stage investment that  have received additional capital through our [Growth Funding](https://www.unicef.org/innovation/growth-funding) to take their solution to the next level of impact also benefit from customized mentorship to support their evolution from good prototype developments to solutions that can be implemented and scaled, with sustainable business models and proven pilots.
...
- [Data Science & A.I.](https://unicef.github.io/ooi-toolkit-ds/)
- [Drones](https://unicef.github.io/drone-4sdgtoolkit/)
- [Open Source](https://unicef.github.io/inventory/)

Since the first Technical Assistance programmes were launched in 2018, the Venture Fund has seen improved results that correlate with the Technical Assistance programmes. In the [most recent Blockchain 2021 cohort](https://www.unicef.org/innovation/venturefund/blockchain-financial-inclusion-graduation), across 500+ hours of mentoring, the cohort collectively reached over 700,000 beneficiaries, raised $4M in follow-on funding, and 4 of 5 graduating companies were recognized as a digital public good before graduation. This also marked a new record of external contributors, with a total of 39 people who contributed to repositories across all portfolio companies. The expert guidance and coaching provided by the team of UNICEF mentors aids the start-ups in achieving new record heights.
...
- [UNICEF Inventory theme](https://github.com/unicef/inventory-hugo-theme) (see “[good first issues](https://github.com/unicef/inventory-hugo-theme/issues?q=is%3Aissue+is%3Aopen+label%3A%22I%3A+good+first+issue%22+no%3Aassignee)”)
- [UNICEF Open Source Inventory](https://github.com/unicef/inventory)
- [UNICEF Data Science & A.I. toolkit](https://github.com/unicef/ooi-toolkit-ds)

With the Digital Public Goods Alliance, we built upon our learnings and successes from portfolio companies and created the [DPG Accelerator Guide](https://unicef.github.io/publicgoods-accelerator-guide/) as a collection of resources for accelerators to also support local ventures in developing digital public goods, setting them up for scale and impact.
