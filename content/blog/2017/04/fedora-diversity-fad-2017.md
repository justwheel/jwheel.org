...
\[caption id="attachment\_3676" align="alignright" width="6000"\][![Team picture of the Diversity Team members (left to right: Brian Exelbierd, Amita Sharma, Radka Janek, Jona Azizaj, Bhagyashree Padalkar, Justin W. Flory)](https://1504253206.rsc.cdn77.org/wp-content/uploads/2017/04/DSC_0031.jpg)](https://1504253206.rsc.cdn77.org/wp-content/uploads/2017/04/DSC_0031.jpg) Team picture of the Diversity Team members (left to right: Brian Exelbierd, Amita Sharma, Radka Janek, Jona Azizaj, Bhagyashree Padalkar, Justin W. Flory)\[/caption\]
...
- Amita Sharma ([amsharma](https://fedoraproject.org/wiki/User:Amsharma))
...
Before the FAD, Maria, Bee, and Marina had compiled a list of questions starting in a [mailing list thread](https://lists.fedoraproject.org/archives/list/diversity@lists.fedoraproject.org/thread/BPV2OTZ5OFMKPTO3PJ5WAYVBHUCE3VXQ/). Many of the questions at the beginning were based on survey questions used in the FLOSS 2013 and [Apache Software Foundation Committer Diversity](https://cwiki.apache.org/confluence/display/COMDEV/ASF+Committer+Diversity+Survey+-+2016) surveys. We started our discussion about the objectives and problems we wanted to solve with this survey. We established these two points as our primary goals.
...
\[caption id="attachment\_3675" align="alignleft" width="6000"\][![The entire team in Brno listening to Maria "tatica" Leandro and Marina Zhurakhinskaya, dialing in from Venezuela and the United States for the Fedora Diversity FAD 2017](https://1504253206.rsc.cdn77.org/wp-content/uploads/2017/04/DSC_0023.jpg)](https://1504253206.rsc.cdn77.org/wp-content/uploads/2017/04/DSC_0023.jpg) The entire team in Brno listening to Maria "tatica" Leandro and Marina Zhurakhinskaya, dialing in from Venezuela and the United States\[/caption\]

With these points in mind, we revisited the draft of questions prepared by Marina. We took an initial pass discussing the questions and weighing if this was something we needed to know and whether we saw a use for the answers based on our goals. The first pass took the longest amount of time, but it narrowed the questions significantly. After getting to a smaller number of questions with varied opinions, the questions were organized them into a spreadsheet where we weighted them by point values and narrowed it down to our final set. Our final draft of questions can be found [in the Pagure ticket](https://pagure.io/fedora-diversity/issue/12#comment-114215) tracking this task. We are awaiting feedback from Fedora Legal before moving forward. Once we receive additional feedback, we plan to revisit the implementation questions about how and where to deploy the survey.
...
\[caption id="attachment\_3674" align="alignright" width="6000"\][![Brian Exelbierd providing input on the demographic survey at the Fedora Diversity FAD 2017](https://1504253206.rsc.cdn77.org/wp-content/uploads/2017/04/DSC_0018.jpg)](https://1504253206.rsc.cdn77.org/wp-content/uploads/2017/04/DSC_0018.jpg) Brian Exelbierd providing input on the demographic survey\[/caption\]
...
Before we all gathered in Brno, we planned to analyze the Fedora code of conduct to understand its strengths and weaknesses. We also wanted to focus on its visibility and ensure that it is well-communicated. This includes new contributors when they first join the community and also current contributors. We [published a post](https://communityblog.fedoraproject.org/what-is-fedora-code-conduct/) about the Fedora Code of Conduct to help raise awareness, but planned to cover this more during our FAD.

\[caption id="attachment\_3678" align="alignleft" width="6000"\][![Getting ready for another day of discussion on Sunday morning for the Fedora Diversity FAD 2017](https://1504253206.rsc.cdn77.org/wp-content/uploads/2017/04/DSC_0043.jpg)](https://1504253206.rsc.cdn77.org/wp-content/uploads/2017/04/DSC_0043.jpg) Getting ready for another day of discussion on Sunday morning\[/caption\]
...
1. What kind of behaviors does the Fedora code of conduct encourage?
2. How are we able to reward positive interactions that show this behavior?
...
The month before the appreciation week would focus on general awareness. This would include a Community Blog article and a post to the [Fedora announce list](https://lists.fedoraproject.org/archives/list/announce%40lists.fedoraproject.org/). The week before the first day would include a Fedora Magazine article explaining what's happening and also to provide a way for users or people outside of the contributor community to participate.

Methods to give thanks included thanking in IRC (either thoughtful messages or with [karma cookies](https://badges.fedoraproject.org/tags/cookie/any)), writing messages on a public wall or forum, and sending personal notes to individual contributors. Methods we could use to measure this impact included but was not limited to were karma cookies, mailing list traffic, or wiki page edits.
...
There are multiple ways you can get in touch with the Diversity Team. We have a [mailing list](https://lists.fedoraproject.org/admin/lists/diversity@lists.fedoraproject.org) you can subscribe to and you can follow our discussions. We have an IRC channel on freenode (`#fedora-diversity`). You . We meet once every other week on Wednesdays at 12:00 UTC in #fedora-meeting on free

- [**Mailing list**](https://lists.fedoraproject.org/admin/lists/diversity@lists.fedoraproject.org): Subscribe to follow our discussions
- **IRC channel**: Say hello in `#fedora-diversity` on freenode (you can [join with a web client](https://webchat.freenode.net/?channels=fedora-diversity) if you don't have an IRC client)
- [**Weekly meeting**](https://apps.fedoraproject.org/calendar/meeting/4422/): Meet every other week on Wednesdays (12:00 UTC) in `#fedora-meeting` on freenode
- [**Pagure tickets**](https://pagure.io/fedora-diversity): See some of the current tasks we're working on and what needs doing

Come say hello and introduce yourself—we'd love to hear what you have to say!

\[caption id="attachment\_3677" align="aligncenter" width="6000"\][![Saturday night dinner with other members of the Fedora community for the Fedora Diversity FAD 2017](https://1504253206.rsc.cdn77.org/wp-content/uploads/2017/04/DSC_0041.jpg)](https://1504253206.rsc.cdn77.org/wp-content/uploads/2017/04/DSC_0041.jpg) Saturday night dinner with other members of the Fedora community\[/caption\]

* * *

_[Heterogeneous group](https://thenounproject.com/search/?q=diversity&i=913730) icon by [Magicon](https://thenounproject.com/magicon) from [the Noun Project](https://thenounproject.com/)_
