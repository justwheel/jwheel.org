...
\[caption id="attachment\_691" align="alignright" width="390"\][![Example of table, or how a RDBMS like MySQL stores data](https://blog.justinwflory.com/wp-content/uploads/2017/07/rbdms-table-example.gif)](https://blog.justinwflory.com/wp-content/uploads/2017/07/rbdms-table-example.gif) Example of table, or how a RDBMS like MySQL stores data. Image from [DevShed](http://www.devshed.com/c/a/php/using-the-active-record-pattern-with-php-and-mysql/).\[/caption\]
...
\[caption id="attachment\_692" align="aligncenter" width="562"\][![Imagine rows and rows of data, uniquely sorted by timestamps](https://blog.justinwflory.com/wp-content/uploads/2017/07/picture-the-cloud.gif)](https://blog.justinwflory.com/wp-content/uploads/2017/07/picture-the-cloud.gif) Imagine rows and rows of data, uniquely sorted by timestamps. Image from [Timescale](https://blog.timescale.com/what-the-heck-is-time-series-data-and-why-do-i-need-a-time-series-database-dcf3b1b18563).\[/caption\]
...
\[caption id="attachment\_693" align="aligncenter" width="638"\][![How InfluxDB stores time-series data in JSON](https://blog.justinwflory.com/wp-content/uploads/2017/07/influxdb-data-format.jpg)](https://blog.justinwflory.com/wp-content/uploads/2017/07/influxdb-data-format.jpg) How InfluxDB stores time-series data in [Line Protocol](https://docs.influxdata.com/influxdb/v1.3/write_protocols/line_protocol_tutorial/). Image from [Roberto Gaudenzi](https://www.slideshare.net/RobertoGaudenzi1/introduction-to-influx-db).\[/caption\]
...
\[caption id="attachment\_703" align="aligncenter" width="661"\][![Diagram of how the different components of the InfluxDB TICK stack connect with each other](https://blog.justinwflory.com/wp-content/uploads/2017/07/tick-stack-diagram.png)](https://blog.justinwflory.com/wp-content/uploads/2017/07/tick-stack-diagram.png) Diagram of how the different components of the TICK stack connect with each other. From [influxdata.com](https://www.influxdata.com/time-series-platform/).\[/caption\]
