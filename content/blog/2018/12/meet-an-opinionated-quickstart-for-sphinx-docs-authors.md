...
The philosophy with this small project is: "_Start writing ReStructuredText already!_" I use Sphinx with ReadTheDocs as a deployment option across [different organizations](https://blog.justinwflory.com/2018/02/unicef-internship/). I want a common base to later customize for a specific project's needs.
