...
I became an active participant in the forum community in Spigot. Through the project, I was [introduced to IRC](https://fedoramagazine.org/beginners-guide-irc/) and how to use it for communicating with other server owners and developers. What I didn't realize was a trend in my behavior. Over time, I began shifting away from asking all the questions. Almost as if in a role reversal, I became the one answering questions and helping support other new server owners or developers. I became the one in an advisory role instead of the one always asking.

\[caption id="attachment\_444" align="aligncenter" width="788"\][![SpigotMC team at annual Minecraft convention, MINECON, in 2015](https://jwfblog.wpenginepowered.com/wp-content/uploads/2016/10/Spigot-Team-1024x683.jpg)](https://jwfblog.wpenginepowered.com/wp-content/uploads/2016/10/Spigot-Team.jpg) [SpigotMC](https://www.spigotmc.org) team at annual Minecraft convention, MINECON, in 2015\[/caption\]
...
However, my open source journey did not end there. After receiving my high school diploma in May 2015, I had set my sights on the [Rochester Institute of Technology](https://www.rit.edu/), a school I noted as having the country's only [Free and Open Source Software minor](https://www.rit.edu/news/story.php?id=50590). By coincidence, I also noticed that my preferred Linux distribution, Fedora, was holding its annual contributor [conference in Rochester](https://fedoramagazine.org/flock-2015-rochester-institute-of-technology/), a week before I would move in for classes. I decided I would make the move up early to see what it was all about.

## Flock 2015 introduces Fedora

The summer passed, and before I knew I was ready, I was packing up from my home outside of Atlanta, Georgia to leave for Rochester, New York. After fourteen hours of driving, I finally arrived and began moving into my new home. A day after I arrived, [Flock](https://flocktofedora.org/) was slated to begin, marking my first journey in Rochester.

\[caption id="attachment\_445" align="aligncenter" width="788"\][![Group photo of Fedora Flock 2015 attendees at the Strong Museum of Play](https://jwfblog.wpenginepowered.com/wp-content/uploads/2016/10/Flock-2015-Strong-Museum-of-Play-1024x684.jpg)](https://jwfblog.wpenginepowered.com/wp-content/uploads/2016/10/Flock-2015-Strong-Museum-of-Play.jpg) Group photo of [Fedora Flock](https://flocktofedora.org/) 2015 attendees at the [Strong Museum of Play](http://www.museumofplay.org/)\[/caption\]

At Flock, I entered as an outsider. I was in an unfamiliar city with unfamiliar people and an open source project I was only mildly familiar with. It was all new to me. But during that week, I discovered a community of people who were united around four common ideals. Freedom, Friends, Features, First: the [Four Foundations](https://fedoraproject.org/wiki/Foundations) of the Fedora Project were made clear to me. The community members at Flock worked passionately towards advancing their project during the talks and workshops. And after the talks finished, they gathered together for hallway discussions, sharing drinks, and enjoying the presence of their (usually) internationally dispersed team. Without having ever attended a Fedora event before, I knew that the Four Foundations and the community behind Fedora were the real deal. Leaving Flock that year, I vowed to pursue becoming a part of this incredible community.

## Pen to paper, keyboard to post

The first major step I took towards contributing to the Fedora Project was in September 2015, during [Software Freedom Day](http://www.softwarefreedomday.org/). Then Fedora Community Action and Impact Coordinator [Remy DeCausemaker](http://decausemaker.org/) was in attendance [representing Fedora](https://fedoraproject.org/wiki/Softwarefreedomday/2015). During the event, I reached out to the [Fedora Magazine](https://fedoramagazine.org/) editorial team asking to become involved as a writer. By the end of September, I penned my first article for the Fedora Magazine, tying in my experience in the Spigot community to Fedora: [run a Minecraft server using Spigot](https://fedoramagazine.org/run-a-minecraft-server-using-spigot/).
...
As I continued writing posts for the Fedora Magazine, I became aware of another team forming up in Fedora: the [Community Operations](https://fedoraproject.org/wiki/CommOps), or CommOps, team. I subscribed to their mailing list, joined the IRC channel, and attended the first meetings. Over time, I became wrapped up and involved with the community efforts within Fedora. I slowly found one thing leading to another.
...
Another challenge you might face as a student or beginner to open source is something called [imposter syndrome](https://opensource.com/life/15/8/interview-major-hayden-rackspace). For me, this was something I had identified with before I knew what it was. For a definition, I'll pull straight from [Wikipedia](https://en.wikipedia.org/wiki/Impostor_syndrome) first: " Term referring to high-achieving individuals marked by an inability to internalize their accomplishments and a persistent fear of being exposed as a "fraud".
...
\[caption id="attachment\_446" align="aligncenter" width="788"\][![River boat cruise dinner with Fedora friends at Flock 2016](https://jwfblog.wpenginepowered.com/wp-content/uploads/2016/10/IMG_9336-1024x683.jpg)](https://jwfblog.wpenginepowered.com/wp-content/uploads/2016/10/IMG_9336.jpg) River boat cruise dinner with Fedora friends at Flock 2016\[/caption\]
