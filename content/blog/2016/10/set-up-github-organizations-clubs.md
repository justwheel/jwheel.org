...
Team structure and designation are some of the most important ways to use organizations effectively. Since GitHub [revamped teams](https://github.com/blog/2020-improved-organization-permissions), they are an effective way to categorize members and to assign privileges. You can decide who can create repositories, who can push code to what repositories, or who has admin rights on projects.
...
For an example of a repository like this, you can see the [FOSSRIT/fossbox-tasks](https://github.com/FOSSRIT/fossbox-tasks/issues) repository on GitHub. We even [planned a dinner](https://github.com/FOSSRIT/fossbox-tasks/issues/16) on GitHub!
