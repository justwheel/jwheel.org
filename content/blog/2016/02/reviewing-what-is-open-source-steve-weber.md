...
- [Steve Weber](https://en.wikipedia.org/wiki/Steven_Weber_%28professor%29), professor at the University of California, Berkeley

## What

- "_The Success of Open Source_"

## Where

- Excerpt of reading found in the HFOSS [ofCourse resources](https://hfoss-ritjoe.rhcloud.com/static/books/Weber-SuccessofOpenSource-Chap3.pdf) or available for purchase on [Amazon](http://www.amazon.com/Success-Open-Source-Steven-Weber/dp/0674018583)
...
_You're in a social setting. Someone says "Hey, did you ever read X?" You quickly respond "Oh heck yeah! X was {awesome,terrible}!" The person next to you in the circle says "Oh snap, I didn't read X. What was it about...?" You have exactly 3 lines, MAX, to prove you are not a hipster—and "The Gist" is those 3 lines._

Chapter 3 of "_What is Open Source?_" essentially aims to define what open source development is as a "thing", describe the process in which it works, the problems it tries to solve, and how it does them. He lightly touches on many core concepts of open source, such as licensing, who is a contributor and what makes someone a contributor in open source, and how the new method of collaboration has positives and negatives—something that reflects human nature.
...
- Analyzing Linus Torvalds' role as the "[Benevolent Dictator for Life](https://en.wikipedia.org/wiki/Benevolent_dictator_for_life)" in the Linux project and how that is reflective of some open source communities
...
- Lastly, I hope [dzho](https://hfoss-ritjoe.rhcloud.com/instructor) will let me pass on the third "bad" thing for the list, as the above two topics were the only things that distinctly stuck out to me.
...
_Imagine you are on Yelp, Amazon, eBay, Netflix, or any other online community that has customer reviews. This is the message that you want to leave behind, to represent yourself, and inform (or warn) others. You should add a quick rating system of your choosing (X/Y stars, X thumbs up) as part of the review._
