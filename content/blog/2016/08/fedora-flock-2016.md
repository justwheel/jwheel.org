...
Although my report comes a little late, it comes with a lot of thought and reflection over the week at Flock. I participated as a speaker for my talk with [Jona Azizaj](https://fedoraproject.org/wiki/User:Jonatoni) titled, "[University Outreach: New task or new mindset?](https://jflory7.fedorapeople.org/pub/flock/2016/university-outreach/flock-2016-university-outreach-new-task-new-mindset-slides.pdf)" I also worked with [Bee Padalkar](https://fedoraproject.org/wiki/User:Bee2502) on running the [Community Operations](https://fedoraproject.org/wiki/CommOps) (CommOps) team workshop for [planning our own future tasks](https://jflory7.fedorapeople.org/pub/flock/2016/commops-workshop/flock-2016-commops-workshop-slides.pdf) in coming months and knowing what issues or topics the community had in mind. And lastly, due to last-minute scheduling issues, I helped plan and organize the [Diversity Panel](https://flock2016.sched.org/event/76nj/diversity-women-in-open-source) with [Amita Sharma](https://fedoraproject.org/wiki/User:Amsharma) and many other incredible contributors.
...
As a second-time visitor to Flock, I was a little familiar with the conference structure. [Joe Brockmeier](https://fedoraproject.org/wiki/User:Jzb) made a [call for volunteers](https://fedoraproject.org/wiki/Flock/Volunteers2016) to help transcribe talks over IRC. I signed myself up to help transcribe all the talks and workshops I was attending to help cover them in the "CommOps-style" way that I run meetings. This proved effective and I hope that my transcriptions were useful both to those who wanted to keep up with Flock from home and attendees who wanted to remember specific parts of talks after the conference ended. You can find an index of all talks and their transcriptions [on the wiki](https://fedoraproject.org/wiki/Flock_2016_Talks).

\[caption id="attachment\_393" align="alignright" width="788"\][![Brian Exelbierd nobly tries to organize Fedora Flock attendees for walking tour](/blog/2016/08/IMG_9238.jpg)](/blog/2016/08/IMG_9238.jpg) [Brian Exelbierd](https://fedoraproject.org/wiki/User:Bex) nobly tries to organize Flock attendees for the walking tour on Tuesday night.\[/caption\]

The event organizers did an effective and incredible job of planning the fine details for the conference. When I arrived on August 1 at the airport, [Rafał Lużyński](https://badges.fedoraproject.org/user/rluzynski) greeted me and provided a ride from the airport to the hotel. Along with us at the airport was [Bee Padalkar](https://fedoraproject.org/wiki/User:Bee2502), [Amita Sharma](https://fedoraproject.org/wiki/User:Amsharma), [Stephen Gallagher](https://fedoraproject.org/wiki/User:Sgallagh) (thanks for sharing a plane ride with me!), and [Ryan Lerch](https://pagure.io/user/ryanlerch). Throughout the entire conference, I was always amazed at the hospitality and constant willingness to help by all the local organizers. For traveling in a country where the language was completely foreign, I never felt too confused or had a difficult time. I remember when Rafał helped translate the menu options for me at the restaurants we ate at on the first day, which was a major help for finding vegetarian choices. My impression on Kraków and then Poland is high and I hope to return again someday in the future.
...
My first talk was on Tuesday. Together with [Jona Azizaj](https://fedoraproject.org/wiki/User:Jonatoni), we presented on the topic of outreach to students and university staff and faculty for the Ambassadors program. The talk structure was past, present, and future. We begin by looking at past efforts and trying to see what we could learn by things that have happened before now. Then, we looked at how Fedora is doing in working towards the [University Involvement Initiative](https://fedoraproject.org/wiki/Objectives/University_Involvement_Initiative) and what tactics are effective now. We also focused on areas of student outreach with the events we are attending now. Everything up to this point was more of presenting information.

\[caption id="attachment\_392" align="alignleft" width="788"\][![Me and Jona during our presentation on University Outreach at Fedora Flock](/blog/2016/08/IMG_9222.jpg)](/blog/2016/08/IMG_9222.jpg) Me and Jona during our presentation on University Outreach in Fedora\[/caption\]
...
The first-ever [Diversity Panel](https://flock2016.sched.org/event/6yp5/diversity-panel-building-an-inclusive-community) was originally headed by Fedora's [Diversity Adviser](https://fedoraproject.org/wiki/Diversity_Adviser), [María 'tatica' Leandro](https://fedoraproject.org/wiki/User:Tatica). But due to medical concerns, María was unable to make it to Flock. [Amita Sharma](https://fedoraproject.org/wiki/User:Amsharma) stepped up to help lead and organize the panel this year. Amita reached out to me for help as a fellow member of the [Diversity Team](https://fedoraproject.org/wiki/Diversity), along with several others at the conference.

\[caption id="attachment\_394" align="alignleft" width="788"\][![Intense thinking on the Diversity Panel at Fedora Flock](/blog/2016/08/IMG_9317.jpg)](/blog/2016/08/IMG_9317.jpg) Panelists on the Diversity Panel intensely thinking about the questions and concerns being fielded by the audience.\[/caption\]
...
Overall, I feel the panel was a great success and I hope to see it become a regular part of Flock every year. We were able to target and name issues that the community feels needed focus in terms of diversity. Awareness was also raised for the incredibly large and diverse community we have. I hope together we can work towards breaking some of the stereotypes of Linux and open source communities, starting with our own. Big thanks (and hugs!) to Amita for helping organize the panel at the last minute, and a round of applause for all the panelists ([Matthew Miller](https://fedoraproject.org/wiki/User:Mattdm), [Marina Zhurakhinskaya](https://fedoraproject.org/wiki/User:Marinaz), [Sylvia Sánchez](https://fedoraproject.org/wiki/User:Lailah), [Bee Padalkar](https://fedoraproject.org/wiki/User:Bee2502), [Jona Azizaj](https://fedoraproject.org/wiki/User:Jonatoni), and [Marie Nordin](https://fedoraproject.org/wiki/User:Riecatnor)).

#### CommOps workshop

The [Community Operations](https://fedoraproject.org/wiki/CommOps) (CommOps) workshop was originally headed by Fedora's [Community Lead](https://fedoraproject.org/wiki/Community_Leader), [Remy DeCausemaker](https://fedoraproject.org/wiki/User:Decause), but due to an [opportunity of a lifetime](http://decausemaker.org/posts/friendsfeaturesfreedomfirstforever.html), he left his position at Red Hat and was unable to make it to Flock. Together with [Bee Padalkar](https://fedoraproject.org/wiki/User:Bee2502), we took over responsibility for this workshop.

Together, we helped plan out the key areas of focus we wanted to have for the workshop. We decided to focus on on-boarding discussions with community members and planning ahead for tasks we wanted to work on in the coming year. We created and developed some [slides](https://jflory7.fedorapeople.org/pub/flock/2016/commops-workshop/flock-2016-commops-workshop-slides.pdf) to help structure the workshop. Most of our preliminary planning work was done in an Etherpad, but some of the general structure and outlining exists in our [wiki planning pad](https://fedoraproject.org/wiki/CommOps/Flock_2016).
...
\[caption id="attachment\_396" align="alignleft" width="788"\][![Bee, Jona, Amita at Kraków brewery at Fedora Flock 2016](/blog/2016/08/IMG_9404.jpg)](/blog/2016/08/IMG_9404.jpg) Bee, Jona, and Amita as we get ready to have dinner at a famous local brewery in Kraków.\[/caption\]
...
To this end, Flock came at the right time for me this year. Over the past few months, I've spent a lot of time working across all different areas. My weekdays focused on Fedora and [Google Summer of Code](https://summerofcode.withgoogle.com/), my weekends woke me up at 4:00am for my weekend job at a [local coffee shop](http://www.dutchmonkeydoughnuts.com/) in my hometown, and any extra time I could sneak goes into managing my now four-year-old Minecraft server community, [CrystalCraftMC](https://crystalcraftmc.com/). Before that, I finished my first year of my undergraduate degree at the [Rochester Institute of Technology](https://www.rit.edu/), and I'm preparing to move back up to Rochester this week.
...
I am incredibly thankful and grateful to be a part of the Fedora community. The opportunity to attend a conference like Flock with sponsorship in a country I've never been to before was an incredible experience. Without a doubt, it's something that will stay with me for a long time. There are so many people I have to thank for helping open a door or offer pointers and tips for getting involved. There's the [Fedora Magazine](https://fedoramagazine.org/) team, the [CommOps](https://fedoraproject.org/wiki/CommOps) team and its [original founder](https://fedoraproject.org/wiki/User:Decause), the [Marketing](https://fedoraproject.org/wiki/Marketing) team, the [Ambassadors](https://fedoraproject.org/wiki/Ambassadors) (both globally and locally), the [Diversity Team](https://fedoraproject.org/wiki/Diversity)… to list names would both be incredibly time-consuming and unfair (because I'm beyond sure I would forget some name of someone who did have an impact on me getting involved).
...
\[caption id="attachment\_391" align="aligncenter" width="788"\][![To Kraków for Flock with Bee, Amita, Jona, and Giannis](/img/IMG_9225.jpg)](/img/IMG_9225.jpg) On a bus to the Kraków city center with Bee, Amita, Jona, and Giannis (left to right).\[/caption\]

## Looking ahead

2016 is past halfway complete and we're on track towards a speedy arrival of 2017. But there is a lot to do before we get there. Flock has helped give the opportunity for the community and all of its teams to find their direction and aim for the next few months and to work towards that. I am refreshed, reinvigorated, and ready for another year of noting all the `#info`, answering the calls for `#help`, and taking on `#action` items to build and grow the Fedora Project forward.
