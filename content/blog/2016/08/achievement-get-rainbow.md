...
Earlier this month, I received the [_Rainbow_ badge](https://badges.fedoraproject.org/badge/rainbow-cookie-v) in [Fedora Badges](https://badges.fedoraproject.org/about). _Rainbow_ is the fifth badge in a series for receiving "karma cookies" from others in IRC. Every time I receive a new badge in this series, I like to [reflect](https://blog.justinwflory.com/2016/03/achievement-get-pizzelle/) back on the past and where my Fedora journey has taken me [since October 2015](https://blog.justinwflory.com/2015/10/my-journey-into-fedora/).
...
This “positive” karma cookies are distributed by zodbot, Fedora's IRC bot. A contributor can give another contributor a “karma cookie” once a release cycle before they are able to give another one. For reaching certain milestones of [karma cookies](https://badges.fedoraproject.org/tags/cookie/any), contributors are awarded badges via Fedora Badges. Fedora uses this as a method to promote positive behavior in the community as well as help support and build community in Fedora. This reflects upon the “Friends” part of the Four Foundations of Fedora. I love the concept of karma cookies and I think it's a small and great way for us to share our appreciation for other contributors in the project.

The [_Rainbow_ badge](https://badges.fedoraproject.org/badge/rainbow-cookie-v) is awarded after receiving 100 karma cookies across all Fedora releases.

## Thank you!

I did spend a lot of time giving thanks and appreciation in my [Flock 2016 write-up](https://blog.justinwflory.com/2016/08/fedora-flock-2016/), so I think it would be better to point there for a longer, more verbose expression of gratitude.
