...
I have stumbled across a single communication platform that exceeds the standards of any other application I've used before: [**Telegram**](https://telegram.org/). And guess what? I'm about to tell you why it's a useful way to communicate over other traditional means.
...
Mileage may vary with this, but often times, how reliable your carrier is leaves you subject to the stability of their network and whether or not your hardware is compatible. In my case, I am a proud owner of an [HTC One M8](http://www.htc.com/us/smartphones/htc-one-m8/) running [CyanogenMod](http://www.cyanogenmod.org/) 12.1, but Sprint has granted me the privilege of having a nearly dysfunctional networking capability on their cellular network. A challenge I have had to face my entire time on Sprint is traveling through an area that _clearly has coverage_, such as New York City, without being able to use any networking capabilities on my phone. I have had to quietly enter a coffee shop just for free WiFi when traveling far… far too many times.
...
This is always the first thing that I notice is that Telegram supports just about everything… literally. From [iOS](https://telegram.org/dl/ios) to [Android](https://telegram.org/dl/android) to [Windows Phone](https://telegram.org/dl/wp) to [Windows desktop app](https://telegram.org/dl/tdesktop) to [OS X desktop app](https://telegram.org/dl/osx) to [Linux desktop app](https://telegram.org/dl/tdesktop) to _[Firefox OS](https://marketplace.firefox.com/app/telegram)_ to a [web platform](https://telegram.org/dl/webogram) and [more](https://telegram.org/apps), it's hard to think of something you can't use Telegram on… except maybe a brick phone from the early 2000s.
...
Finally, Telegram is also a platform you can trust. On the Electronic Frontier Foundation's [Secure Messaging Scorecard](https://www.eff.org/secure-messaging-scorecard), the platform as a whole receives a 4/7 and the secret messaging feature receives a perfect score of 7/7. It's a non-commercial product that has [high value in privacy](https://telegram.org/faq#q-what-are-your-thoughts-on-internet-privacy), something that is respectable and admirable in the current day and age.
