...
\[caption id="" align="alignleft" width="183"\]![The Open Source Initiative](http://opensource.org/files/osi_standard_logo.png) The Open Source Initiative. Source: [opensource.org](http://opensource.org/)\[/caption\]
...
This is something that is probably one of the most discussed parts of Free and Open Source Software (FOSS), yet it is without a doubt one of the most important. At the end of the day, the people who work behind major FOSS projects such as Linux distributions (like Fedora), major software programs and languages, and even [Minecraft server software](https://www.spigotmc.org/) share a core set of beliefs: the software you and I use needs to place value in freedom to manipulate and distribute as we see fit. It is within our right to do with our software as we wish. This is something that I sincerely believe will help bring the world to a better place.

Seeing as this _is_ one of the most discussed elements of FOSS, I will not spend as much time on this. But it is important to realize that it is part of the foundation that everything else builds from.
...
There is more that goes on for open source communities than just writing code too, so even if you're someone like me who loves to write, there are ample opportunities to help in a fun and meaningful way. The articles I publish on the [Fedora Magazine](https://fedoramagazine.org/author/jflory7/) and [Fedora Community Blog](https://communityblog.fedoraproject.org/author/jflory7/) are enjoyable for me to write, and every thankful comment received makes it just the more worth it. For instance, I recently [published an article](https://fedoramagazine.org/never-leave-irc-znc/) about using an IRC bouncer software called ZNC and shared it across multiple channels of communication. Shortly after doing so, a user messaged me and asked questions about using the software I described in the article, and shortly after our discussion, he successfully tested and started using ZNC for his own IRC communication. How awesome is that?! Even just by contributing writing, I can readily see my impact on users.
...
\[caption id="" align="alignleft" width="945"\]![Software Freedom Day, celebrating free and open source software](https://fedoramagazine.org/wp-content/uploads/2015/11/sfd2015-945x400.jpg) Software Freedom Day is an event held annually to celebrate the values of free and open source software. Source: [Fedora Magazine](https://fedoramagazine.org/celebrating-software-freedom-day-2015/)\[/caption\]
