...
> 
> [Official conference website](https://2020.copyleftconf.org/)
...
CopyleftConf 2020 is one of the best conferences I have attended. I bought my ticket the morning of the conference. Karen Sandler and Bradley Kuhn fired me up the day before in their [FOSDEM 2020 talk](/blog/2020/03/fosdem-2020-pt-1-play-by-play/). My initial reluctance to go was because I assumed it was a conference for FOSS lawyers. While it definitely includes that group, it isn't exclusive to that group. CopyleftConf 2020 collected people from a diverse range of experiences and backgrounds in the open source world.
...
- [Keynote](https://2020.copyleftconf.org/schedule/presentation/20/) (_[Tony Sebro](https://twitter.com/keynote2k)_)
- [Copyleft adoption curves: what drove adoption then (or now?)](https://2020.copyleftconf.org/schedule/presentation/9/) ([_Luis Villa_](https://twitter.com/luis_in_brief))
- [Copyleft Expansion: What should -- and shouldn't -- be on the table?](https://2020.copyleftconf.org/schedule/presentation/13/) (_Deb Nicholson, Bradley M. Kuhn, Allison Randal, Heather J. Meeker, John Sullivan_)
- [The Rising Ethical Storm in Open Source](https://2020.copyleftconf.org/schedule/presentation/17/) ([_Coraline Ada Ehmke_](https://twitter.com/CoralineAda))
- [Software Ethics and Copyleft Licensing](https://2020.copyleftconf.org/schedule/presentation/19/) (_[Karen Sandler](https://twitter.com/o0karen0o)_)
...
> 
> [Luis Villa](https://twitter.com/luis_in_brief)
...
On the Saturday before CopyleftConf 2020, I presented at FOSDEM 2020 with my colleague and dear friend Mike Nolan on [three new freedoms for AI](https://fosdem.org/2020/schedule/event/ethical_ai/) that go beyond software. In our talk, we analyzed the history of how Free Software began as a social movement. It roughly flowed as follows:
...
On one hand, we need to be ready to have these conversations about real effects and the impact of what we do on people. Look at the [Facebook news feed and the Myanmar genocide](https://www.reuters.com/article/us-myanmar-rohingya-un/myanmar-generals-had-genocidal-intent-against-rohingya-must-face-justice-u-n-idUSKCN1LC0KN). Legal semantics is where we are stuck since we defined the Four Freedoms. But these freedoms are no longer enough.
...
- **[Software Freedom Conservancy](https://sfconservancy.org/)**: For creating and holding this important space.
