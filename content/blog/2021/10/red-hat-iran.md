...
As Fedora Linux is forced to this decision by its relationship to its legal sponsor, Red Hat, **I therefore believe it is also the responsibility of Red Hat to seek a solution that does not deny an individual their right to realize the [Four Freedoms](https://fsfe.org/freesoftware/) of Free Software on the basis of geography or citizenship**.
...
> 
> _[Advancing developer freedom: GitHub is fully available in Iran](https://github.blog/2021-01-05-advancing-developer-freedom-github-is-fully-available-in-iran/) - github.blog_
...
After all, in Fedora, we are well-known for being [first](https://docs.fedoraproject.org/en-US/project/#_first) in the Open Source space for innovative new ideas and approaches. We know Fedora Linux is a [digital public good](https://digitalpublicgoods.net/registry/fedora-linux.html) that should be accessible to all and everyone. But to make this a reality, the Fedora Project cannot be first here on its own. We need our friendly primary sponsor, Red Hat, to help us clear this burden, which is brought on by our connection to Red Hat in the first place.
...
> 
> _From [What is Fedora all about?](https://docs.fedoraproject.org/en-US/project/#_first)_

Here is a chance to be clear on the future we want to provide and for whom.

* * *

_Background photo by [Omid Armin](https://unsplash.com/@omidarmin?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)._
