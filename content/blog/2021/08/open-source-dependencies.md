...
So, what if Open Source dependencies weren't _just_ software? Furthermore, what if Open Source dependencies could mean people… or simply, human beings? In this blog post, we'll walk through this thought experiment.
...
If you exist within the dynamic of an existing community, you benefit from resources, people, and infrastructure that would be unavailable if you started independently. Finding communities with compatible values and motives exposes you to a wider network, and thus more visibility in a world where there is already _too much_ information. Working within an existing community can cut light-years off of time-to-market or improving product sustainability and community resiliency (in the context of other variables).

### Example of community inheritance

The [Fedora Project](https://docs.fedoraproject.org/en-US/project/) produces Fedora Linux. [Fedora Linux](https://getfedora.org/) is a Free and Open Source operating system derived from the open source Linux kernel. The Fedora Project also creates other software in order to facilitate the production, creation, and updates of Fedora Linux. Examples of this are asynchronous [meeting minute note managers](https://github.com/fedora-infra/mote), [community calendars](https://github.com/fedora-infra/fedocal), [gamified badges](https://badges.fedoraproject.org/about), [software package distribution tools](https://pagure.io/koji), and more.
...
[From Wikipedia](https://en.wikipedia.org/wiki/File:Get_out_of_jail_free.jpg).
...
Open Source does not get a ["get out of jail free" card](https://en.wikipedia.org/wiki/Get_Out_of_Jail_Free_card).
